...
void setup_scr_screen(lv_ui *ui)
{
    ...
    lv_obj_set_pos(ui->screen_cont_1, 23, 10);
    lv_obj_set_size(ui->screen_cont_1, 437, 773);
    ...
    lv_obj_set_pos(ui->screen_btn_1, 189, 315);
    ...
    lv_obj_set_style_bg_color(ui->screen_btn_1, lv_color_hex(0xd3a630), LV_PART_MAIN|LV_STATE_DEFAULT);
    ...
    lv_obj_set_pos(ui->screen_bar_1, 71, 158);
    lv_obj_set_size(ui->screen_bar_1, 358, 21);
    ...
    lv_obj_set_style_bg_color(ui->screen_bar_1, lv_color_hex(0x1662a3), LV_PART_MAIN|LV_STATE_DEFAULT);
